...
import { X, Download, CalendarDays, CheckCircle2 } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-hidden relative">
        ...
        {/* ── 面談依頼パネル（ダウンロード後にスライドアップ）── */}
        {showConsult && (
          <div className="absolute inset-x-0 bottom-0 z-10 animate-in slide-in-from-bottom duration-300">
            <div className="mx-auto max-w-lg bg-white rounded-t-2xl shadow-2xl border border-slate-200 p-5 max-h-[75vh] overflow-y-auto">
              {/* 閉じるボタン */}
              <button
